...
const links: QuickLink[] = [
  ...
  { label: "Overtakes", href: "/overtakes", icon: Zap, color: "text-purple-500", bgColor: "bg-purple-500/10" },
  { label: "Speed", href: "/speed-traps", icon: Gauge, color: "text-pink-500", bgColor: "bg-pink-500/10" },
